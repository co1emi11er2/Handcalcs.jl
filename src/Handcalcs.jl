...
export @handcalc, @handcalcs, latexify, multiline_latex, set_default, get_default, reset_default, @handfunc, calc_Ix, @handfunc2, @handfunc3, @handfunc4 #, initialize_format
